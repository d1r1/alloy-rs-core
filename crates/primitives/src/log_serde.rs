...
mod tests {
    ...
    fn test_log_json_roundtrip() {
        let expected = "{\"logs\":[{\"address\":\"0x000000000000000000000000003100000000000000000000000000000000000001\",\"topics\":[\"0x32eff959e2e8d1609edc4b39ccf75900aa6c1da5719f8432752963fdf008234f\"],\"data\":\"\"}]}";
